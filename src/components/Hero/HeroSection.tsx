        ...
        <>
            <motion.section  className="flex flex-col h-110 bg-[url('https://cdn.searchenginejournal.com/wp-content/uploads/2022/08/google-shopping-ads-6304dccb7a49e-sej.png')] overflow-hidden bg-cover items-center bg-no-repeat justify-center xl:items-start  xl:h-150 w-full">
                ...
                <motion.div initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0 }} transition={{duration:1 , ease:'easeOut' ,delay:0.2}} className="flex flex-col text-center xl:text-left  xl:ml-20 gap-4 relative ">
                    ...
                    <motion.p initial={{opacity:0 , y:-100}} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0}} transition={{duration:1 , ease:'easeOut' ,delay:0.6}} className="text-white text-lg">Shop the latest trends with fast delivery and exclusive deals.</motion.p>
