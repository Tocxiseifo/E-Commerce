...
export default function NavBar() {
    ...
    const {favorite, cart} = useShop(); //custom hook contain the context data
    useEffect(() =>{
            ...
            <nav className="bg-white text-text-color flex flex-row justify-between items-center text-center  w-full h-18 sticky top-0 z-50">
                <div className="flex flex-row text-center justify-between gap-8  ml-12 w-full items-center">
                    <div className="flex flex-row w-full gap-6">
                        <h1 className="text-3xl font-semibold text-text-color">Shoply</h1>
                    ...
                    <div className="flex flex-row text-center gap-4 mr-12 justify-center items-center">
                        <span className="cursor-pointer text-[16px] text-white bg-main duration-500 transition hover:duration-500 hover:bg-white hover:text-main hover:border-main border  w-18 h-9 text-center flex justify-center items-center rounded-md">LogIn</span>
