...
export default function PromoSection() {
    return(
        <motion.div initial={{opacity:0 , x:-100}} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay: 0.4}} className="w-full lg:h-100 bg-yellow-400 flex flex-col-reverse lg:flex-row justify-between items-center mt-110 overflow-hidden  bg-cover bg-center h-130 relative top-390 lg:top-0 ">
            <motion.div initial={{opacity:0 , x:100}} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:0.8}} className='lg:ml-35'>
